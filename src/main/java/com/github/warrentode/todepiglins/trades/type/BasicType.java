package com.github.warrentode.todepiglins.trades.type;

import com.github.warrentode.todepiglins.TodePiglins;
import com.github.warrentode.todepiglins.trades.TodePiglinMerchantTrade;
import com.github.warrentode.todepiglins.trades.TradeSerializer;
...
public class BasicType implements ITradeType<TodePiglinMerchantTrade> {
    ...
    @Override
    public TodePiglinMerchantTrade createVillagerTrade() {
    ...
    public static class Serializer extends TradeSerializer<BasicType> {
        Serializer() {
            super(new ResourceLocation(TodePiglins.MODID, "basic"));
        }
        ...
        private JsonObject serializeItemStack(@NotNull ItemStack stack) {
        ...
        private JsonObject serializeEnchantment(@NotNull EnchantmentInstance enchantment) {
            JsonObject object = new JsonObject();
        ...
        private JsonObject serializePotionEffect(@NotNull MobEffectInstance effect) {
            JsonObject object = new JsonObject();
        ...
        private Collection<EnchantmentInstance> getEnchantments(@NotNull JsonArray enchantmentArray) {
        ...
        private Collection<MobEffectInstance> getPotionEffects(@NotNull JsonArray effectsArray) {
    ...
    public static class Builder {
        ...
        public void setOfferStack(ItemStack offerStack) {
            this.offerStack = offerStack;
        }
        public void setPaymentStack(ItemStack paymentStack) {
            this.paymentStack = paymentStack;
        }
        public void setSecondaryPaymentStack(ItemStack secondaryPaymentStack) {
            this.secondaryPaymentStack = secondaryPaymentStack;
        }
